...
module.exports = {
        ...
        headers: [
          {
            ...
            value: `
              ...
              img-src 'self' data: https://dummyimage.com https://lh3.googleusercontent.com https://maps.gstatic.com https://maps.googleapis.com; 
              connect-src 'self' https://tokyoquest.onrender.com https://maps.googleapis.com https://0.0.0.0:8000; 
              frame-src 'self';
            `.trim().replace(/\s{2,}/g, ' '),
          },
          {
  ...
  images: {
    domains: ['dummyimage.com', 'lh3.googleusercontent.com', 'maps.gstatic.com', 'maps.googleapis.com', '/images/logoBlackWhite'],
  },
  eslint: {
    ignoreDuringBuilds: true,
  },
